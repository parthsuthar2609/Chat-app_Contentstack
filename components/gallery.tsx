...
const GalleryReact = ({ data, heading, headingTags, description, descriptionTags, showFilter, showDescription }: { data: any, heading: any, headingTags?: {}, description: any, descriptionTags?: {}, showFilter: boolean, showDescription: boolean }) => {
                ...
                heading ?
                    <>
                        <nav className="navbar mt-2">
                            <span className="navbar-brand mb-0 m-auto h1 text-center" {...(headingTags as {})}>
                                {heading}
                            </span>
                        </nav><br />
                    </>
            ...
            }
            {
                description ?
                    <div className='container'>
                        <p className=" text-center" {...(descriptionTags as {})}>
                            {description}
                        </p>
                    </div>
                    : ''
